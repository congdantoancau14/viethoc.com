...
<tr>
	...
	<span class="italic">Chuyện Tình Thứ Nhất</span>&nbsp;<br /> by: admin on: Friday 14 February @ 16:19:57</td></tr><tr><td class="type5">Lúc xa cách
	...
	Mỗi người một ngả,
...
Tan rồi lại hợp.
	Đúng ba năm,
	Tôi được thả.
Hai mươi sáu năm sau, người em hiền hơn hoa cỏ, người yêu bé-nhỏ xinh-xinh thỏ thẻ bên tai:
	“...
...
Sau khi chuyển nhập xong phần Chữ Nôm, chúng tôi được phép tác giả cho đăng lại trên Trang Nhà Việt Học bài <a href="https://www.viethoc.org/eholdings/DungXua_Rev-2.pdf" target="new_target">Dung Xưa</a>.

Kính mời quý vị vào <a href="https://www.viethoc.org/content.php?menu=24&page_id=47" target="new_target">Việt-Học Thư Quán</a> đọc một câu chuyện tình nhẹ như mây, trong như thuỷ tinh hầu cùng tác giả ôn lại một kỷ niệm xưa, nhớ người em bé nhỏ xinh xinh.

Lê Văn Ðặng
Seattle, 14-II-2003

 </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: Chuyện Tình Thứ Nhất" onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
