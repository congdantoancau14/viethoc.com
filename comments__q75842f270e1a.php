...
<tr>
	...
	<span class="italic">Long Thành Cầm Giả Ca</span>&nbsp;<br /> by: avuong on: Monday 25 March @ 21:03:56</td></tr><tr><td class="type5">龍城佳人  姓氏不記清  獨擅阮琴  
...
<b><a href="/eholdings/LongThanhCamGiaCa.pdf">Long Thành Cầm Giả Ca</a></b>  龍城琴者歌 của  <b><i>Nguyễn Du</i></b>  阮攸 có nhiều dị bản.  Chúng tôi có trình bày bản do <b><i>Lãng Nhân</i></b> sưu tập.  Nay xin thay bản đó bằng bản trích trong <b>Bắc Hành Tạp Lục</b> 北行雜錄 .  Bản Quốc ngữ của <b>Học Canh</b> vẫn được giữ lại.

<i>Lê Văn Ðặng</i> </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: Long Thành Cầm Giả Ca" onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
