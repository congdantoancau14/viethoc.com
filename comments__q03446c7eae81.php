...
<tr>
	...
	<span class="italic">Lời tựa Lam Sơn Thực Lục</span>&nbsp;<br /> by: plan on: Tuesday 17 December @ 12:47:45</td></tr><tr><td class="type5">Thân mời quý vị ghé vào <a href="https://www.viethoc.org/content.php?menu=24&page_id=47" target="new_window"> Việt Học Thư Quán</a> để tham khảo.  </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: Lời tựa Lam Sơn Thực Lục" onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
