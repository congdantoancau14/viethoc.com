...
<tr>
	...
	<span class="italic">Tiếng Việt và ngôn ngữ học hiện đại: Sơ khảo về cú pháp</span>&nbsp;<br /> by: plan on: Monday 24 February @ 22:24:45</td></tr><tr><td class="type5">Thân mời quý vị vào <a href="https://www.viethoc.org/content.php?menu=2400&page_id=56" target="new_window">Trang Thân Hữu</a> đọc tập biên khảo và chuyên luận <a href="https://www.vnx.org/eholdings/Syntax.pdf" target="new_window">Tiếng Việt và ngôn ngữ học hiện đại: Sơ khảo về cú pháp</a> của ông Vũ Tiến Dũng.
Trân trọng,
Viện Việt-học </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: Tiếng Việt và ngôn ngữ học hiện đại: Sơ khảo về cú pháp" onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
