...
<tr>
	...
	<span class="italic">Những điều trông thấy mà đau đớn lòng</span>&nbsp;<br /> by: admin on: Tuesday 18 February @ 11:03:18</td></tr><tr><td class="type5"><p>Xin mời quý vị vào <a href="https://www.viethoc.org/content.php?menu=24&page_id=47" target="new_window">Việt-Học Thư Quán</a> đọc <a href="https://www.viethoc.org/eholdings/sokienhanh_Rev-1.pdf" target="new_window">Những điều trông thấy mà đau đớn lòng</a>. </p>

Viện Việt-Học
 </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: Những điều trông thấy mà đau đớn lòng" onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
