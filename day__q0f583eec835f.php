...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20031228">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Monday, December 29, 2003			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20031230">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20031222">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20031229">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20031229">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20040105">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
...
<b>December</b>
 <select name="date">
			<option value="20031201">01</option><option value="20031202">02</option><option value="20031203">03</option><option value="20031204">04</option><option value="20031205">05</option><option value="20031206">06</option><option value="20031207">07</option><option value="20031208">08</option><option value="20031209">09</option><option value="20031210">10</option><option value="20031211">11</option><option value="20031212">12</option><option value="20031213">13</option><option value="20031214">14</option><option value="20031215">15</option><option value="20031216">16</option><option value="20031217">17</option><option value="20031218">18</option><option value="20031219">19</option><option value="20031220">20</option><option value="20031221">21</option><option value="20031222">22</option><option value="20031223">23</option><option value="20031224">24</option><option value="20031225">25</option><option value="20031226">26</option><option value="20031227">27</option><option value="20031228">28</option><option value="20031229" selected="selected">29</option><option value="20031230">30</option><option value="20031231">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20031229" />
					<select name="filter">
