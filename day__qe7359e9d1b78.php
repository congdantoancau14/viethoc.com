...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20041008">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Saturday, October 9, 2004			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20041010">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20041002">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20041009">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20041009">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20041016">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
...
<b>October</b>
 <select name="date">
			<option value="20041001">01</option><option value="20041002">02</option><option value="20041003">03</option><option value="20041004">04</option><option value="20041005">05</option><option value="20041006">06</option><option value="20041007">07</option><option value="20041008">08</option><option value="20041009" selected="selected">09</option><option value="20041010">10</option><option value="20041011">11</option><option value="20041012">12</option><option value="20041013">13</option><option value="20041014">14</option><option value="20041015">15</option><option value="20041016">16</option><option value="20041017">17</option><option value="20041018">18</option><option value="20041019">19</option><option value="20041020">20</option><option value="20041021">21</option><option value="20041022">22</option><option value="20041023">23</option><option value="20041024">24</option><option value="20041025">25</option><option value="20041026">26</option><option value="20041027">27</option><option value="20041028">28</option><option value="20041029">29</option><option value="20041030">30</option><option value="20041031">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20041009" />
					<select name="filter">
