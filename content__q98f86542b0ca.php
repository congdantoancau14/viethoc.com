...
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td class="type0">
	  ...
	  <td class="type5">
          <table width="100%"><tr>  
               <td class="type5" width="90%" valign="top"><span class="boldtext">Bảng tra chữ Hán-Nôm bằng Quốc Ngữ</span><br />Lập trình này chỉ dùng được với Internet Explorer 5.0. Nếu quý vị muốn thấy được chữ Hán-Nôm hiện trong hộp chữ lớn, quý vị cần cài gắn bộ chữ <a href="aruniupd.exe">MS Arial Unicode</a>.<p>
<b>Cách sử dụng</b>: Sau khi đánh một chữ quốc ngữ vào ô <b>[Tìm chữ]</b>, những chữ Hán-nôm tương ứng sẽ hiện ra với số thứ tự cho mỗi chữ, kế đó bạn có thể gõ một số thứ tự để đem chữ đó vào hộp chữ lớn ở dưới .  (Ngoài ra, thay vì đánh một chữ quốc ngữ, bạn cũng có thể đánh thẳng mã của một ký tự Unicode vào ô <b>[Tìm chữ]</b> bằng ký ngữ: $xxxx.  Thí dụ: Chữ "<b>Việt</b>" = $8d8a).
<hr />
<center>
<IFRAME src="https://www.vnet.org/vanlangsj/nomtool/nomkey.htm" width="100%" height="500" FRAMEBORDER="No">
</IFRAME>
</center></td></tr></td></tr></td></tr></td></tr></td></tr>   </table>
            </td>
          </tr>
          </table>
          </td>
