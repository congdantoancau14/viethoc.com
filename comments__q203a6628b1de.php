...
<tr>
	...
	<span class="italic">Re: Trao đổi với Lê Hữu Mục về một số nhận</span>&nbsp;(Score: 0)<br /> by: Anonymous on: Wednesday 16 July @ 13:22:29</td></tr><tr><td class="type5">Từ xưa tôi chỉ biết Đoàn Thị Điểm là tác giả Chinh Phụ Ngâm, bây giờ lại thấy chuyện này, thực hy hữu. </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: Trao đổi với Lê Hữu Mục về một số nhận" onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
