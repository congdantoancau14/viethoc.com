...
<tr>
	...
	<span class="italic">Trao đổi với Lê Hữu Mục...</span>&nbsp;<br /> by: plan on: Wednesday 16 July @ 11:55:15</td></tr><tr><td class="type5">Kính mời quý thân hữu vào <a href="https://www.viethoc.org/content.php?menu=24&page_id=47" target="new_window">Việt Học Thư Quán</a> đọc bài <a href="https://www.viethoc.org/eholdings/Chinhphunga-2003.pdf" target="new_window">Trao đổi với Lê Hữu Mục về một số nhận định của ông qua Tiếng nói Đoàn thị Điểm trong Chinh-phụ ngâm khúc.</a> Bài Nguyên Tựa trình bày trước đây, trích trong bài này, sẽ được lấy ra khỏi trang nhà Việt-Học.<br><br>Seattle, 03-VII-2003<br>Lê Văn Ðặng
 </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: Trao đổi với Lê Hữu Mục..." onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
