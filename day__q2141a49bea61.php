...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20030405">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Sunday, April 6, 2003			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20030407">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20030330">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20030406">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20030406">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20030413">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
...
<b>April</b>
 <select name="date">
			<option value="20030401">01</option><option value="20030402">02</option><option value="20030403">03</option><option value="20030404">04</option><option value="20030405">05</option><option value="20030406" selected="selected">06</option><option value="20030407">07</option><option value="20030408">08</option><option value="20030409">09</option><option value="20030410">10</option><option value="20030411">11</option><option value="20030412">12</option><option value="20030413">13</option><option value="20030414">14</option><option value="20030415">15</option><option value="20030416">16</option><option value="20030417">17</option><option value="20030418">18</option><option value="20030419">19</option><option value="20030420">20</option><option value="20030421">21</option><option value="20030422">22</option><option value="20030423">23</option><option value="20030424">24</option><option value="20030425">25</option><option value="20030426">26</option><option value="20030427">27</option><option value="20030428">28</option><option value="20030429">29</option><option value="20030430">30</option><option value="20030401">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20030406" />
					<select name="filter">
