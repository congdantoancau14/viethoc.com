...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20030923">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Wednesday, September 24, 2003			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20030925">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20030917">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20030924">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20030924">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20031001">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
...
<b>September</b>
 <select name="date">
			<option value="20030901">01</option><option value="20030902">02</option><option value="20030903">03</option><option value="20030904">04</option><option value="20030905">05</option><option value="20030906">06</option><option value="20030907">07</option><option value="20030908">08</option><option value="20030909">09</option><option value="20030910">10</option><option value="20030911">11</option><option value="20030912">12</option><option value="20030913">13</option><option value="20030914">14</option><option value="20030915">15</option><option value="20030916">16</option><option value="20030917">17</option><option value="20030918">18</option><option value="20030919">19</option><option value="20030920">20</option><option value="20030921">21</option><option value="20030922">22</option><option value="20030923">23</option><option value="20030924" selected="selected">24</option><option value="20030925">25</option><option value="20030926">26</option><option value="20030927">27</option><option value="20030928">28</option><option value="20030929">29</option><option value="20030930">30</option><option value="20030901">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20030924" />
					<select name="filter">
