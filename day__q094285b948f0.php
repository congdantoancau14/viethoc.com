...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20041220">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Tuesday, December 21, 2004			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20041222">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20041214">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20041221">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20041221">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20041228">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
...
<b>December</b>
 <select name="date">
			<option value="20041201">01</option><option value="20041202">02</option><option value="20041203">03</option><option value="20041204">04</option><option value="20041205">05</option><option value="20041206">06</option><option value="20041207">07</option><option value="20041208">08</option><option value="20041209">09</option><option value="20041210">10</option><option value="20041211">11</option><option value="20041212">12</option><option value="20041213">13</option><option value="20041214">14</option><option value="20041215">15</option><option value="20041216">16</option><option value="20041217">17</option><option value="20041218">18</option><option value="20041219">19</option><option value="20041220">20</option><option value="20041221" selected="selected">21</option><option value="20041222">22</option><option value="20041223">23</option><option value="20041224">24</option><option value="20041225">25</option><option value="20041226">26</option><option value="20041227">27</option><option value="20041228">28</option><option value="20041229">29</option><option value="20041230">30</option><option value="20041231">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20041221" />
					<select name="filter">
