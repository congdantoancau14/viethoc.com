...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20050212">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Sunday, February 13, 2005			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20050214">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />

	<table width="98%" class = "type0" cellspacing="0" cellpadding="1" border="0">
		<tr><td>
			<table width="100%" class="type5" cellspacing="1" cellpadding="2" border="0">

<tr><td class="type2">Time</td><td class="type2">Event</td>
			<td class="type2">Subcategory</td><td class="type2">Location</td></tr>
	<tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>			</table>
		</td></tr></table>
</center>
<br /><br />

<!-- Navigation tools below -->
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20050206">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20050213">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20050213">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20050220">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
...
<b>February</b>
 <select name="date">
			<option value="20050201">01</option><option value="20050202">02</option><option value="20050203">03</option><option value="20050204">04</option><option value="20050205">05</option><option value="20050206">06</option><option value="20050207">07</option><option value="20050208">08</option><option value="20050209">09</option><option value="20050210">10</option><option value="20050211">11</option><option value="20050212">12</option><option value="20050213">13</option><option value="20050214">14</option><option value="20050215">15</option><option value="20050216">16</option><option value="20050217">17</option><option value="20050218">18</option><option value="20050219">19</option><option value="20050220">20</option><option value="20050221">21</option><option value="20050222">22</option><option value="20050223">23</option><option value="20050224">24</option><option value="20050225">25</option><option value="20050226">26</option><option value="20050227">27</option><option value="20050228">28</option><option value="20050201">29</option><option value="20050202">30</option><option value="20050203">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20050213" />
					<select name="filter">
						<option value="0">Show All Events</option>

<option value="2"
		>Sinh-hoạt</option><option value="1"
		>Thuyết Trình</option><option value="4"
		>Trình diễn</option><option value="5"
		>Trình diễn</option><option value="3"
		>Trình diễn âm nhạc</option>					</select>
					<input type="submit" value="Filter Events" />
			</form>
		</td>
	</tr>
</table>
<br /><hr /><span class="normaltext">
