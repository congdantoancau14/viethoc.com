...
<tr>
	...
	<span class="italic">CHỮ NÔM và CÔNG VIỆC KHẢO CỨU CỔ VĂN VIỆT NAM</span>&nbsp;<br /> by: plan on: Tuesday 06 August @ 18:57:59</td></tr><tr><td class="type5"><p>Vào tháng 3 năm 1942, giáo sư Dương Quảng Hàm phổ biến một bài khảo cứu về chữ Nôm trên Bulletin général de l’Instruction publique.  Thân mời quý vị vào <a href="https://www.viethoc.org/content.php?menu=24&page_id=47">Việt Học Thư Quán</a> đọc bản <a href="https://www.viethoc.org/content.php?menu=24&page_id=47">Quốc ngữ</a> của giáo sư Lê Văn Ðặng có thêm một số phụ chú.</p><br /> </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: CHỮ NÔM và CÔNG VIỆC KHẢO CỨU CỔ VĂN VIỆT NAM" onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
