...
<tr>
	...
	<span class="italic">Đào Hoa Thi - Revision 1</span>&nbsp;<br /> by: Ly on: Tuesday 25 September @ 14:15:47</td></tr><tr><td class="type5">Prof. Lê Văn Đặng just sent us the revised copy of his work on Nguyễn Trãi's Đào Hoa Thi, and we are happy to share his paper with you. In this revision, Prof. Lê provided English interpretation of Nguyễn Trãi's poems, and replacement of a Nôm character. Please take a look at the revised article <a href="/eholdings/DaoHoaThi.pdf">Đào Hoa Thi here.</a> </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: Đào Hoa Thi - Revision 1" onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
