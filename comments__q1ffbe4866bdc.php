...
<tr>
	...
	<span class="italic">Tỳ Bà Hành ( 琵琶行) - Bản mới</span>&nbsp;<br /> by: admin on: Friday 14 February @ 13:37:00</td></tr><tr><td class="type5"><p>Quý vị có thể vào <a href="https://www.viethoc.org/content.php?menu=24&page_id=47" target="new_window">Việt Học Thư Quán</a> đọc nguyên tác Tỳ Bà Hành và bản dịch của Phan Huy Vịnh.</p>

Viện Việt Học </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: Tỳ Bà Hành ( 琵琶行) - Bản mới" onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
