...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20030610">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Wednesday, June 11, 2003			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20030612">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20030604">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20030611">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20030611">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20030618">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
	...
	<tr>
		<td align="left" valign="bottom">
			<form action="./month.php" method="post">
				<select name="month">
<option value="01" >January</option><option value="03" >March</option><option value="03" >March</option><option value="04" >April</option><option value="05" >May</option><option value="06"selected="selected" >June</option><option value="07" >July</option><option value="08" >August</option><option value="09" >September</option><option value="10" >October</option><option value="11" >November</option><option value="12" >December</option>
				</select>
				<select name="year">
...
<b>June</b>
 <select name="date">
			<option value="20030601">01</option><option value="20030602">02</option><option value="20030603">03</option><option value="20030604">04</option><option value="20030605">05</option><option value="20030606">06</option><option value="20030607">07</option><option value="20030608">08</option><option value="20030609">09</option><option value="20030610">10</option><option value="20030611" selected="selected">11</option><option value="20030612">12</option><option value="20030613">13</option><option value="20030614">14</option><option value="20030615">15</option><option value="20030616">16</option><option value="20030617">17</option><option value="20030618">18</option><option value="20030619">19</option><option value="20030620">20</option><option value="20030621">21</option><option value="20030622">22</option><option value="20030623">23</option><option value="20030624">24</option><option value="20030625">25</option><option value="20030626">26</option><option value="20030627">27</option><option value="20030628">28</option><option value="20030629">29</option><option value="20030630">30</option><option value="20030601">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20030611" />
					<select name="filter">
