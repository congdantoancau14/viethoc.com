...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20040114">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Thursday, January 15, 2004			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20040116">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20040108">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20040115">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20040115">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20040122">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
	...
	<tr>
		<td align="left" valign="bottom">
			<form action="./month.php" method="post">
				<select name="month">
<option value="01"selected="selected" >January</option><option value="03" >March</option><option value="03" >March</option><option value="04" >April</option><option value="05" >May</option><option value="06" >June</option><option value="07" >July</option><option value="08" >August</option><option value="09" >September</option><option value="10" >October</option><option value="11" >November</option><option value="12" >December</option>
				</select>
				<select name="year">
...
<b>January</b>
 <select name="date">
			<option value="20040101">01</option><option value="20040102">02</option><option value="20040103">03</option><option value="20040104">04</option><option value="20040105">05</option><option value="20040106">06</option><option value="20040107">07</option><option value="20040108">08</option><option value="20040109">09</option><option value="20040110">10</option><option value="20040111">11</option><option value="20040112">12</option><option value="20040113">13</option><option value="20040114">14</option><option value="20040115" selected="selected">15</option><option value="20040116">16</option><option value="20040117">17</option><option value="20040118">18</option><option value="20040119">19</option><option value="20040120">20</option><option value="20040121">21</option><option value="20040122">22</option><option value="20040123">23</option><option value="20040124">24</option><option value="20040125">25</option><option value="20040126">26</option><option value="20040127">27</option><option value="20040128">28</option><option value="20040129">29</option><option value="20040130">30</option><option value="20040131">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20040115" />
					<select name="filter">
