...
<tr>
	...
	<span class="italic">TRUYỀN THỐNG PHÁP TRỊ TRONG LỊCH SỬ VIỆT NAM</span>&nbsp;<br /> by: plan on: Monday 03 March @ 13:13:57</td></tr><tr><td class="type5">Xin xem <a href="https://www.viethoc.org/images/user_pages/VHTmTVT_31503-U.pdf" target="new_window">Thiệp mời</a> để biết thêm chi tiết về chương trình, đề tài và diễn giả. </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: TRUYỀN THỐNG PHÁP TRỊ TRONG LỊCH SỬ VIỆT NAM" onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
