...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20030819">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Wednesday, August 20, 2003			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20030821">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20030813">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20030820">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20030820">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20030827">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
...
<b>August</b>
 <select name="date">
			<option value="20030801">01</option><option value="20030802">02</option><option value="20030803">03</option><option value="20030804">04</option><option value="20030805">05</option><option value="20030806">06</option><option value="20030807">07</option><option value="20030808">08</option><option value="20030809">09</option><option value="20030810">10</option><option value="20030811">11</option><option value="20030812">12</option><option value="20030813">13</option><option value="20030814">14</option><option value="20030815">15</option><option value="20030816">16</option><option value="20030817">17</option><option value="20030818">18</option><option value="20030819">19</option><option value="20030820" selected="selected">20</option><option value="20030821">21</option><option value="20030822">22</option><option value="20030823">23</option><option value="20030824">24</option><option value="20030825">25</option><option value="20030826">26</option><option value="20030827">27</option><option value="20030828">28</option><option value="20030829">29</option><option value="20030830">30</option><option value="20030831">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20030820" />
					<select name="filter">
