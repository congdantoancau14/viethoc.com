...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20030608">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Monday, June 9, 2003			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20030610">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20030602">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20030609">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20030609">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20030616">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
 ...
 <select name="date">
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20030609" />
					<select name="filter">
