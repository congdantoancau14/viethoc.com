...
<tr>
	...
	<span class="italic">Re: Tỳ Bà Hành</span>&nbsp;(Score: 0)<br /> by: Anonymous on: Sunday 10 March @ 00:35:32</td></tr><tr><td class="type5">Ca'c anh cho em ho?i  nhe':<br>
Trong ba?n tie^'ng Ha'n, ddo.c tho+ le^n nghe cu+' nhu+ la` <em>Tha^'t Va^.n</em><br>
Va^.y tho+ na`y thuo^.c the^? gi` va^.y? </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
