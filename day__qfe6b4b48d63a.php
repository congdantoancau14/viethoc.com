...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20060116">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Tuesday, January 17, 2006			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20060118">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20060110">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20060117">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20060117">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20060124">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
...
<b>January</b>
 <select name="date">
			<option value="20060101">01</option><option value="20060102">02</option><option value="20060103">03</option><option value="20060104">04</option><option value="20060105">05</option><option value="20060106">06</option><option value="20060107">07</option><option value="20060108">08</option><option value="20060109">09</option><option value="20060110">10</option><option value="20060111">11</option><option value="20060112">12</option><option value="20060113">13</option><option value="20060114">14</option><option value="20060115">15</option><option value="20060116">16</option><option value="20060117" selected="selected">17</option><option value="20060118">18</option><option value="20060119">19</option><option value="20060120">20</option><option value="20060121">21</option><option value="20060122">22</option><option value="20060123">23</option><option value="20060124">24</option><option value="20060125">25</option><option value="20060126">26</option><option value="20060127">27</option><option value="20060128">28</option><option value="20060129">29</option><option value="20060130">30</option><option value="20060131">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20060117" />
					<select name="filter">
