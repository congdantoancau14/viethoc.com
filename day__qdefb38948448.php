...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20030314">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Saturday, March 15, 2003			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20030316">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<tr><td class="type2">Time</td><td class="type2">Event</td>
	...
	<tr><td width="10%" align="left">2:00pm</td>
			<td bgcolor="#d4d4d4"><a href="./event.php?event_id=24">TRUYỀN THỐNG PHÁP TRỊ TRONG LỊC</a></td>
			<td bgcolor="#d4d4d4"><a href="./subcatinfo.php?subcat_id=7">Văn-minh Việt-nam</a></td>
			<td bgcolor="#d4d4d4"><a href="./location.php?loc_id=2">Viện Việt-Học</a></td></tr>
					</table>
		</td></tr></table>
</center>
<br /><br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20030308">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20030315">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20030315">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20030322">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
...
<b>March</b>
 <select name="date">
			<option value="20030301">01</option><option value="20030302">02</option><option value="20030303">03</option><option value="20030304">04</option><option value="20030305">05</option><option value="20030306">06</option><option value="20030307">07</option><option value="20030308">08</option><option value="20030309">09</option><option value="20030310">10</option><option value="20030311">11</option><option value="20030312">12</option><option value="20030313">13</option><option value="20030314">14</option><option value="20030315" selected="selected">15</option><option value="20030316">16</option><option value="20030317">17</option><option value="20030318">18</option><option value="20030319">19</option><option value="20030320">20</option><option value="20030321">21</option><option value="20030322">22</option><option value="20030323">23</option><option value="20030324">24</option><option value="20030325">25</option><option value="20030326">26</option><option value="20030327">27</option><option value="20030328">28</option><option value="20030329">29</option><option value="20030330">30</option><option value="20030331">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20030315" />
					<select name="filter">
