...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20030709">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Thursday, July 10, 2003			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20030711">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20030703">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20030710">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20030710">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20030717">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
	...
	<tr>
		<td align="left" valign="bottom">
			<form action="./month.php" method="post">
				<select name="month">
<option value="01" >January</option><option value="03" >March</option><option value="03" >March</option><option value="05" >May</option><option value="05" >May</option><option value="07"selected="selected" >July</option><option value="07"selected="selected" >July</option><option value="08" >August</option><option value="10" >October</option><option value="10" >October</option><option value="12" >December</option><option value="12" >December</option>
				</select>
				<select name="year">
...
<b>July</b>
 <select name="date">
			<option value="20030701">01</option><option value="20030702">02</option><option value="20030703">03</option><option value="20030704">04</option><option value="20030705">05</option><option value="20030706">06</option><option value="20030707">07</option><option value="20030708">08</option><option value="20030709">09</option><option value="20030710" selected="selected">10</option><option value="20030711">11</option><option value="20030712">12</option><option value="20030713">13</option><option value="20030714">14</option><option value="20030715">15</option><option value="20030716">16</option><option value="20030717">17</option><option value="20030718">18</option><option value="20030719">19</option><option value="20030720">20</option><option value="20030721">21</option><option value="20030722">22</option><option value="20030723">23</option><option value="20030724">24</option><option value="20030725">25</option><option value="20030726">26</option><option value="20030727">27</option><option value="20030728">28</option><option value="20030729">29</option><option value="20030730">30</option><option value="20030731">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20030710" />
					<select name="filter">
