...
<tr>
	...
	<span class="italic">Prof. Le, Dang published 214 radicals for Nôm</span>&nbsp;<br /> by: admin on: Thursday 05 April @ 16:19:10</td></tr><tr><td class="type5">Responding to the needs of students and many Nôm scholars, prof. Le created and published the table for <a href="214bo_eng.pdf">214 Historical Radicals of Nôm</a>.  </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: Prof. Le, Dang published 214 radicals for Nôm" onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
