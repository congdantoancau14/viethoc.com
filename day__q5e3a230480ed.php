...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20041116">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Wednesday, November 17, 2004			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20041118">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20041110">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20041117">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20041117">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20041124">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
...
<b>November</b>
 <select name="date">
			<option value="20041101">01</option><option value="20041102">02</option><option value="20041103">03</option><option value="20041104">04</option><option value="20041105">05</option><option value="20041106">06</option><option value="20041107">07</option><option value="20041108">08</option><option value="20041109">09</option><option value="20041110">10</option><option value="20041111">11</option><option value="20041112">12</option><option value="20041113">13</option><option value="20041114">14</option><option value="20041115">15</option><option value="20041116">16</option><option value="20041117" selected="selected">17</option><option value="20041118">18</option><option value="20041119">19</option><option value="20041120">20</option><option value="20041121">21</option><option value="20041122">22</option><option value="20041123">23</option><option value="20041124">24</option><option value="20041125">25</option><option value="20041126">26</option><option value="20041127">27</option><option value="20041128">28</option><option value="20041129">29</option><option value="20041130">30</option><option value="20041101">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20041117" />
					<select name="filter">
