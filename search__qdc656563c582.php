...
<tr>
	<td class="type4">Search in Announcement</td></tr>
<tr><td class="type5">
<table width="100%" border="0">
<tr>
	<td class="type5">
	<img src="./images/topics/announces.gif" align="right" border="0" alt="Announcement" />
	...
	<option value="">All Topics</option>
		<option selected="selected"  value="13">Announcement</option>
