...
<tr>
	...
	<span class="italic">Chữ Nôm or the Former Vietnamese Script and its Past Contributions to Vietnam</span>&nbsp;<br /> by: plan on: Thursday 12 September @ 12:10:50</td></tr><tr><td class="type5"><p>In our recently published Monograph on Nom Characters we included a summary in Japanese of a 1974  research article by Professor Nguyen Khac Kham of the Tokyo University of Foreign Studies. At the request of a number of readers, we have now posted in <a href="https://www.viethoc.org/content.php?menu=24&page_id=47" target=new_window">Việt-Học Thư Quán</a> a <a href="https://www.viethoc.org/eholdings/NKK-Jap.pdf" target=new_window">Vietnamese version by Mr. Nguyen Duc Kinh</a> of the above-mentioned summary. This summary in Vietnamese is also included with the article by Professor Nguyen Khac Kham, which is made available individually from the Monograph on Nom Characters.</p>
The Institute of Vietnamese Studies </td></tr></table>&nbsp;<form action="comments.php" method="post">Your Name: Anonymous<br /><br />Subject:<br />
	<input type="text" name="subject" size="55" maxlength="60" value="Re: Chữ Nôm or the Former Vietnamese Script and its Past Contributions to Vietnam" onkeypress="return (vietKey(this))" /><br /><br />
	Comment:<br />
	...
	<input type="hidden" name="sid" value="43" />
