...
<center>
	<table width="99%" cellpadding = "4" cellspacing="0" border ="0">
		<tr><td width="20%" align="left" class="type4">&lt;&lt;<a href="./day.php?date=
			20030224">Previous Day</a></td>
			<td align="center" width="60%" class="type4bigger">
				VVH Calendar Events<br />Tuesday, February 25, 2003			</td>
			<td width="20%" align="right"  class="type4"><a href="./day.php?date=20030226">Next Day</a>&gt;&gt;</td>
		</tr>
	</table>
	<br />
...
<center>
	<table width="98%" cellpadding = "0" cellspacing="0">
		<tr>
			<td width="25%" align="left">&lt;&lt;<a href="./day.php?date=20030218">Previous Week</a></td>
			<td width="25%" align="center"><a href="./week.php?date=20030225">This Week</a></td>
			<td width="25%"  align="center"><a href="./month.php?date=20030225">This Month</a></td>
			<td width="25%" align="right"><a href="./day.php?date=20030304">Next Week</a>&gt;&gt;</td>
		</tr></table>
</center>
<br />
...
<b>February</b>
 <select name="date">
			<option value="20030201">01</option><option value="20030202">02</option><option value="20030203">03</option><option value="20030204">04</option><option value="20030205">05</option><option value="20030206">06</option><option value="20030207">07</option><option value="20030208">08</option><option value="20030209">09</option><option value="20030210">10</option><option value="20030211">11</option><option value="20030212">12</option><option value="20030213">13</option><option value="20030214">14</option><option value="20030215">15</option><option value="20030216">16</option><option value="20030217">17</option><option value="20030218">18</option><option value="20030219">19</option><option value="20030220">20</option><option value="20030221">21</option><option value="20030222">22</option><option value="20030223">23</option><option value="20030224">24</option><option value="20030225" selected="selected">25</option><option value="20030226">26</option><option value="20030227">27</option><option value="20030228">28</option><option value="20030201">29</option><option value="20030202">30</option><option value="20030203">31</option>					</select>
	...
	<tr>
		<td colspan="3" align="center">
			<form action="./day.php" method="post">
				<input type="hidden" name="date" value="20030225" />
					<select name="filter">
